...
const Signup = () => {
	...
	const postDetails = (pics) => {
		...
		if (pics.type === "image/jpeg" || pics.type === "image/png") {
			...
			fetch("https://api.cloudinary.com/v1_1/duvkpqgev/image/upload", { method: "post", body: data })
				.then((res) => res.json())
				.then((data) => {
			...
			toast({ title: "Please Select an Image (jpeg or png)", status: "warning", duration: 5000, isClosable: true, position: "bottom" });
			setLoading(false);
			return;
		}
	};
